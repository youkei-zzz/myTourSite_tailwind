<template>
  <div class="fixed w-[100vw] top-0 z-50">
            ...
            <DialogPanel class="relative mr-16 flex w-full max-w-[300px] flex-1">
              ...
              <div class="flex grow flex-col gap-y-5 overflow-y-auto bg-white px-6 pb-2 dark:bg-slate-800">
                <div class="flex shrink-0 mt-3 justify-between items-center">
                  <img class="h-12 w-auto hidden dark:block" src="@/assets/image/light-logo.webp" alt="logo"/>
                  <img class="h-12 w-auto dark:hidden" src="@/assets/image/dark-logo.webp" alt="logo"/>
    ...
    <div
        class="sticky top-0 z-50 flex items-center justify-between px-5 bg-white py-5 shadow-md lg:hidden dark:bg-slate-800">
      ...
      <div class="flex items-center gap-2">
        ...
        <span class="relative inline-flex">
					...
					<span v-if="logInfoStore.getLogInStatus() && other.showTip === true"
